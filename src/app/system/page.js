...
function ProgressChart({ data }) {
  ...
  if (!data.length) {
    return (
      <div className="flex h-[220px] sm:h-[240px] items-center justify-center rounded-[22px] border border-dashed border-white/10 text-sm text-zinc-500">
  ...
  return (
    <div className="overflow-x-auto">
      <svg viewBox={`0 0 ${width} ${height}`} className="h-[220px] sm:h-[240px] w-full">
...
function SectionCard({ children, className = "" }) {
  return (
    <section
      className={`rounded-[24px] sm:rounded-[30px] border border-white/10 bg-white/[0.03] shadow-[0_0_0_1px_rgba(255,255,255,0.02)_inset] ${className}`}
    >
      {children}
    </section>
  );
...
export default function SystemPage() {
  ...
  if (loading) {
    return (
      <main className="min-h-screen bg-zinc-950 px-4 sm:px-6 py-6 sm:py-10 text-white">
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.10),transparent_20%),linear-gradient(180deg,#07070a_0%,#0a0a10_100%)] px-4 sm:px-6 lg:px-8 py-6 sm:py-10 text-white">
      <div className="mx-auto w-full max-w-6xl space-y-6 sm:space-y-8">
        <header className="rounded-[24px] sm:rounded-[34px] border border-white/10 bg-white/[0.04] p-5 sm:p-6 md:p-8 shadow-[0_10px_60px_rgba(0,0,0,0.35)]">
          <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
            <div className="space-y-4">
              ...
              <div>
                <h1 className="text-3xl sm:text-5xl md:text-7xl font-semibold tracking-[-0.04em] break-words">
                  Système {profile?.username || "Utilisateur"}
                </h1>
                <p className="mt-3 sm:mt-4 max-w-4xl text-sm sm:text-base md:text-lg text-zinc-400">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                <Link href="/profile" className="rounded-xl sm:rounded-2xl border border-white/10 bg-white/10 px-3 sm:px-4 py-2 text-xs sm:text-sm hover:bg-white/15">Profil</Link>
                <Link href="/settings" className="rounded-xl sm:rounded-2xl border border-white/10 bg-white/10 px-3 sm:px-4 py-2 text-xs sm:text-sm hover:bg-white/15">Paramètres</Link>
                <Link href="/friends" className="rounded-xl sm:rounded-2xl border border-white/10 bg-white/10 px-3 sm:px-4 py-2 text-xs sm:text-sm hover:bg-white/15">Amis</Link>
                <Link href="/friends/requests" className="rounded-xl sm:rounded-2xl border border-white/10 bg-white/10 px-3 sm:px-4 py-2 text-xs sm:text-sm hover:bg-white/15">Demandes</Link>
                <Link href="/social" className="rounded-xl sm:rounded-2xl border border-white/10 bg-white/10 px-3 sm:px-4 py-2 text-xs sm:text-sm hover:bg-white/15">Social</Link>
                <Link href="/history" className="rounded-xl sm:rounded-2xl border border-white/10 bg-white/10 px-3 sm:px-4 py-2 text-xs sm:text-sm hover:bg-white/15">Historique</Link>
                <Link href="/progression" className="rounded-xl sm:rounded-2xl border border-white/10 bg-white/10 px-3 sm:px-4 py-2 text-xs sm:text-sm hover:bg-white/15">Progression</Link>
                {activeSession ? (
                  <Link
                    href={`/workout/${activeSession.training_day_id}`}
                    className="rounded-xl sm:rounded-2xl border border-emerald-500/20 bg-emerald-500/10 px-3 sm:px-4 py-2 text-xs sm:text-sm text-emerald-300 hover:bg-emerald-500/15"
                  >
                    Reprendre la séance
                  </Link>
                ) : null}
            ...
            <div className="grid gap-3 sm:grid-cols-3 xl:min-w-[560px]">
              <div className="rounded-xl sm:rounded-2xl border border-white/10 bg-black/20 p-4">
                <p className="text-xs text-zinc-500">Séances terminées</p>
                <p className="mt-2 text-2xl sm:text-3xl font-semibold tracking-[-0.04em]">
        ...
        {activeSession ? (
          <SectionCard className="border-emerald-500/20 bg-emerald-500/[0.06] p-4 sm:p-5 md:p-6">
            <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
              <div>
                <p className="text-sm text-emerald-300">Séance active</p>
                <h2 className="mt-1 text-2xl sm:text-3xl font-semibold tracking-[-0.03em]">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-xl sm:rounded-2xl border border-white/10 bg-black/20 px-4 py-3">
                  <p className="text-xs text-zinc-500">Chronomètre</p>
                  <p className="mt-1 text-2xl sm:text-3xl font-semibold tracking-[-0.04em]">
                ...
                <Link
                  href={`/workout/${activeSession.training_day_id}`}
                  className="flex items-center justify-center rounded-xl sm:rounded-2xl border border-emerald-500/20 bg-emerald-500/10 px-5 py-3 text-sm text-emerald-300 hover:bg-emerald-500/15"
                >
                  Ouvrir la séance
                </Link>
              </div>
        ...
        <SectionCard className="p-4 sm:p-5 md:p-6">
          <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="text-2xl sm:text-3xl font-semibold tracking-[-0.03em]">Records & volume</h2>
          ...
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
            <div className="rounded-[18px] sm:rounded-[22px] border border-white/10 bg-black/20 p-4 sm:p-5">
              <p className="text-sm text-zinc-400">Volume ce mois</p>
              <p className="mt-2 text-3xl sm:text-4xl font-semibold tracking-[-0.04em]">
                {formatNumber(performanceStats.monthVolume)}
              </p>
            </div>
          ...
          <div className="mt-5 rounded-[18px] sm:rounded-[24px] border border-white/10 bg-black/20 p-4 md:p-5">
            <div className="mb-4">
              <h3 className="text-lg sm:text-xl font-medium">Progression volume</h3>
              <p className="mt-1 text-sm text-zinc-400">
        ...
        <SectionCard className="p-4 sm:p-5 md:p-6">
          <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="text-2xl sm:text-3xl font-semibold tracking-[-0.03em]">Priorisation des muscles</h2>
              <p className="mt-1 text-sm text-zinc-400">
          ...
          {topView === "board" ? (
              ...
              {["maintenance", "moderate", "priority"].map((key) => {
                ...
                return (
                  <div
                    ...
                    className={`rounded-[20px] sm:rounded-[24px] border p-4 transition ${config.columnClass} ${
                    ...
                    <div className="space-y-3">
                      {list.map((muscle) => (
                        <div
                          ...
                          className={`cursor-grab rounded-[16px] sm:rounded-[18px] border p-4 active:cursor-grabbing ${config.cardClass}`}
                        >
                          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                            <div>
                              <p className="text-base sm:text-lg font-medium">{muscle.name}</p>
                            ...
                            <select
                              ...
                              className="w-full sm:w-auto rounded-xl border border-white/10 bg-black/30 px-3 py-2 text-sm text-white outline-none"
                            >
                      ...
                      {list.length === 0 ? (
                        <div className="rounded-[16px] sm:rounded-[18px] border border-dashed border-white/10 p-4 text-sm text-zinc-500">
                          Aucun muscle ici.
                        </div>
                      ) : null}
                    </div>
            ...
            <div className="overflow-x-auto rounded-[18px] sm:rounded-[24px] border border-white/10 bg-black/20">
        ...
        <SectionCard className="p-4 sm:p-5 md:p-6">
          <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="text-2xl sm:text-3xl font-semibold tracking-[-0.03em]">Programme</h2>
              <p className="mt-1 text-sm text-zinc-400">
          ...
          <div className="grid gap-4 xl:grid-cols-3">
            <div className="rounded-[18px] sm:rounded-[22px] border border-white/10 bg-black/20 p-4 sm:p-5">
              ...
              <form onSubmit={handleCreateDay} className="mt-4 flex flex-col sm:flex-row gap-3">
                <input
                  value={newDayName}
                  onChange={(e) => setNewDayName(e.target.value)}
                  placeholder="Nom de la séance"
                  className="h-11 flex-1 rounded-xl sm:rounded-2xl border border-white/10 bg-zinc-900 px-4 text-white outline-none"
                />
                <button
                  type="submit"
                  className="h-11 rounded-xl sm:rounded-2xl border border-white/10 bg-white/10 px-4 text-sm hover:bg-white/15"
                >
                  Ajouter
                </button>
              </form>
            ...
            <div className="rounded-[18px] sm:rounded-[22px] border border-white/10 bg-black/20 p-4 sm:p-5">
              ...
              <form onSubmit={handleCreateCustomExercise} className="mt-4 space-y-3">
                <select
                  ...
                  className="h-11 w-full rounded-xl sm:rounded-2xl border border-white/10 bg-zinc-900 px-4 text-white outline-none"
                >
                ...
                <button
                  type="submit"
                  className="w-full sm:w-auto rounded-xl sm:rounded-2xl border border-white/10 bg-white/10 px-4 py-2 text-sm hover:bg-white/15"
                >
                  Créer
                </button>
              </form>
          ...
          {customTemplates.length > 0 ? (
            <div className="mt-5 rounded-[18px] sm:rounded-[24px] border border-white/10 bg-black/20 p-4 sm:p-5">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                {customTemplates.map((item) => (
                  <div
                    key={item.id}
                    className="rounded-xl sm:rounded-2xl border border-white/10 bg-zinc-900/60 p-4"
                  >
          ...
          {bottomView === "week" ? (
            <div className="mt-5 space-y-5">
              ...
              <div className="grid gap-4 xl:grid-cols-2">
                {dayBoards.map((day) => (
                  <div key={day.id} className={`rounded-[20px] sm:rounded-[24px] border p-4 sm:p-5 ${day.colorClass}`}>
                    ...
                    <div className="mt-5 space-y-2">
                      {day.items.slice(0, 6).map((item) => (
                        <div
                          key={item.id}
                          className="flex items-center justify-between rounded-xl sm:rounded-2xl border border-white/10 bg-black/20 px-3 py-2"
                        >
                          <div className="min-w-0 pr-3">
                            <p className="text-sm font-medium truncate">{item.exercise_templates?.name}</p>
                            <p className="text-xs text-zinc-400 truncate">
                              {item.exercise_templates?.muscles?.name}
                            </p>
                          </div>

                          <span className="shrink-0 text-xs text-zinc-300">{item.set_count} séries</span>
                        </div>
                      ))}

                      {day.items.length === 0 ? (
                        <div className="rounded-xl sm:rounded-2xl border border-dashed border-white/10 px-3 py-4 text-sm text-zinc-500">
              ...
              <div className="flex gap-4 pb-2">
                {muscleBoards.map((muscle) => {
                  ...
                  return (
                    <div
                      key={muscle.id}
                      className={`min-w-[280px] sm:min-w-[300px] rounded-[20px] sm:rounded-[24px] border p-4 ${muscle.colorClass}`}
                    >
                      ...
                      <div className="space-y-3">
                        {muscle.items.map((item) => (
                          <div
                            key={item.id}
                            className="rounded-[16px] sm:rounded-[18px] border border-white/10 bg-black/20 p-3"
                          >
                            <div className="flex items-center justify-between gap-3">
                              <div className="min-w-0">
                                <p className="font-medium truncate">{item.exercise_templates?.name}</p>
                ...
                {dayBoards.map((day) => {
                  ...
                  return (
                    <div
                      ...
                      className={`min-w-[300px] sm:min-w-[320px] rounded-[20px] sm:rounded-[24px] border p-4 transition ${day.colorClass} ${
                        isOver ? "ring-2 ring-white/20" : ""
                      }`}
                    >
                      <div className="mb-4 flex items-center justify-between gap-3">
                      ...
                      <div className="space-y-3">
                        {day.items.map((item) => (
                          <div
                            ...
                            className={`cursor-grab rounded-[16px] sm:rounded-[18px] border p-3 active:cursor-grabbing ${
